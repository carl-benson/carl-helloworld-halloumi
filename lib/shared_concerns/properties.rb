...
module Concerns
  # Shared Properties for {HelloWorld}.
  module Shared
    module Properties
      ...
      included do
        ...
        # @!attribute [rw] consumer_subnets
        #   Allow consumer access from the subnets in this string.
        #   Specify one or more IP addresses or CIDRs separated by commas and or
        #   spaces.
        #   @return [String] consumer_subnets
        property :consumer_subnets,
                 filter: Halloumi::Filters.string_to_array,
                 env: :CONSUMER_SUBNETS
